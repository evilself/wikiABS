...
<body>
	<div class="col-lg-12 col-sm-12">
	    ...
	    <div class="modal-body">		        
	 		<sf:form id="registerForm" action="${flowExecutionUrl}">
	       ...
	       <button class="btn btn-default ajaxRegisterButton pull-right" id="ajaxSubmitBtn" onclick="ajaxRegister($('#url').val())"><spring:message code="newUserRegistration.registerbutton"/></button>	           	   
